 ...
 */
package com.cygnus.launcher.qsb.configs;
...
import com.cygnus.launcher.CygnusLauncher;
import com.cygnus.launcher.CygnusLauncherCallbacks;
import com.cygnus.launcher.qsb.AllAppsQsbContainer;
import com.cygnus.launcher.search.nano.SearchProto.Columns;
import com.cygnus.launcher.search.nano.SearchProto.AppIndex;
import com.cygnus.launcher.search.nano.SearchProto.SearchBase;
import com.cygnus.launcher.search.nano.SearchProto.SearchView;
import com.cygnus.launcher.search.AppSearchProvider;
...
public class ConfigurationBuilder {
    ...
    public CygnusLauncher mLauncher;
    ...
    public static Intent getSearchIntent(Rect sourceBounds, View gIcon, View micIcon) {
        ...
        return intent.putExtra("source_round_left", true)
                ...
                .setPackage(CygnusLauncherCallbacks.SEARCH_PACKAGE).addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY | Intent.FLAG_ACTIVITY_NEW_TASK);
    }
