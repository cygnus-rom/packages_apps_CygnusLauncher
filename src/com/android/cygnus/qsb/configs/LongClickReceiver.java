...
public class LongClickReceiver extends BroadcastReceiver {
    ...
    public static WeakReference<CygnusLauncher> mWeakReference = new WeakReference(null);

    public static void getWeakReference(CygnusLauncher launcher) {
        mWeakReference = new WeakReference(launcher);
    }

    @Override
    public void onReceive(Context context, Intent intent) {
        CygnusLauncher launcher = (CygnusLauncher) mWeakReference.get();
        if (launcher != null) {
